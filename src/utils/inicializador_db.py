...
def inicializar_todos_los_dat_semilla():
    ...
    semillas = {
        "usuarios.dat": [
            Usuario(
                id_u=1,
                username_correo="sofia.ramirez@unl.edu.ec",
                contrasena="pass123",
            ...
            Usuario(
                id_u=2,
                username_correo="juan.perez@unl.edu.ec",
                contrasena="pass123",
            ...
            Usuario(
                id_u=3,
                username_correo="ana.nunez@unl.edu.ec",
                contrasena="pass123",
            ...
            Usuario(
                id_u=4,
                username_correo="carlos.mendoza@unl.edu.ec",
                contrasena="pass123",
                rol=RolUsuario.TUTOR_ACADEMICO,
                id_p=1,
            ),
            Usuario(
                id_u=5,
                username_correo="tutoremp1@unl.edu.ec",
                contrasena="pass123",
                rol=RolUsuario.TUTOR_EMPRESARIAL,
                id_p=1,
            ),
            Usuario(
                id_u=6,
                username_correo="info@techsolutions.com",
                contrasena="pass123",
                rol=RolUsuario.EMPRESARIO,
                id_p=1,
            ),
        ],
        "administradores.dat": [
